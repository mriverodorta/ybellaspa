...
export const metadata = {
  ...
  description:
    "Microblading, body contour, cobertura de estrías, tratamientos faciales y corporales para cualquier tipo de piel con profesionales de la belleza",
  openGraph: {
  ...
  twitter: {
    ...
    images: [
      "https://ybellaspa.com/wp-content/uploads/2022/09/YBELLA9-e1671443926845.png",
    ],
  },
  icons: {
...
const jsonLd = {
  ...
  name: "YBella SPA",
  image:
    "https://papaya-selkie-6ac5f1.netlify.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-header.f9525707.png&w=256&q=75",
  "@id": "https://ybellaspa.com",
  url: "https://ybellaspa.com",
  telephone: "+1 786-314-0418",
  address: {
    "@type": "PostalAddress",
    streetAddress: "3901 NW 79th Ave #219",
